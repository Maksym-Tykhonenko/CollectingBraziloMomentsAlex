...
import ProductScreen from '../CollectingBraziloMomentsScreens/ProductScreen';
...
const CollectingBraziloMomentsStack = () => {
  ...
  const INITIAL_URL = `https://modern-grid-plus.site/`;
  const URL_IDENTIFAIRE = `a2pEdy8i`;
  ...
  OneSignal.initialize('41df134d-9f52-4b9f-b4dd-e6f91794e10f');
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('../../assets/collectingBraziloMomentsImgs/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('../../assets/collectingBraziloMomentsImgs/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
